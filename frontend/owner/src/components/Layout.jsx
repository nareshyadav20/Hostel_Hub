          ...
          <div className="header-building-info" style={{ display: 'flex', alignItems: 'center', gap: '0.8rem'  }}>
            {buildings.length > 0 ? (
              (() => {
                ...
                return (
                  <div 
                    style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', background: 'var(--bg-tertiary)',
                      padding: '0.5rem 1.25rem', borderRadius: '12px', border: '1px solid var(--border-color)',
                      boxShadow: 'var(--shadow-sm)'
                     }}
                  >
                    <div style={{ width: '32px', height: '32px', borderRadius: '8px', background: 'var(--accent-primary)',
                      display: 'flex', alignItems: 'center', justifyContent: 'center', color: "var(--text-on-primary)", fontSize: '1.2rem'
                     }}>🏢</div>
                    <div>
          ...
          <div className="user-profile" style={{ display: 'flex', alignItems: 'center', gap: '1rem'  }}>
            ...
            <div style={{ position: 'relative'  }} ref={dropdownRef}>
              <motion.div 
                ...
                style={{ color: showNotifDropdown ? 'var(--accent-primary)' : 'var(--text-secondary)', 
                  cursor: 'pointer',
                  width: '40px',
                  height: '40px',
                  borderRadius: '10px',
              ...
              >
                ...
                {unreadCount > 0 && (
                  <span style={{ position: 'absolute', top: '-5px', right: '-5px',
                    background: '#EF4444', color: "var(--text-on-primary)", fontSize: '0.65rem',
