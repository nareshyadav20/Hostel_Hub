...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { name: 'Buildings', path: `/owner/building/${activeBuildingId}/buildings`, icon: <Building {...iconProps} /> },
    { name: 'Rooms & Beds', path: `/owner/building/${activeBuildingId}/rooms`, icon: <BedDouble {...iconProps} /> },
    { name: 'Tenants', path: `/owner/building/${activeBuildingId}/tenants`, icon: <Users {...iconProps} /> },
    { name: 'Payments', path: `/owner/building/${activeBuildingId}/payments`, icon: <Wallet {...iconProps} /> },
    { name: 'Staff', path: `/owner/building/${activeBuildingId}/staff`, icon: <Briefcase {...iconProps} /> },
    { name: 'Mess Menu', path: `/owner/building/${activeBuildingId}/mess`, icon: <Utensils {...iconProps} /> },
    { name: 'Complaints', path: `/owner/building/${activeBuildingId}/complaints`, icon: <MessageSquare {...iconProps} /> },
    { name: 'Transfers', path: `/owner/building/${activeBuildingId}/transfers`, icon: <RefreshCw {...iconProps} /> },
    { name: 'Inventory', path: `/owner/building/${activeBuildingId}/inventory`, icon: <Package {...iconProps} /> },
    { name: 'Reports', path: `/owner/building/${activeBuildingId}/reports`, icon: <BarChart {...iconProps} /> },
