    ...
    {isOpen && (
      ...
      >
        <motion.div
          ...
          style={{ width: '94%', maxWidth, padding: '0',
              ...
              <div style={{ display: 'flex', gap: '1rem', borderBottom: "1px solid var(--border-color)", marginBottom: '1.5rem'  }}>
                {['Overview', 'Payments', 'Stay Details', 'Documents'].map(tab => (
                  <button
                    ...
                    style={{ background: 'transparent', border: 'none', padding: '0.8rem 1rem', fontSize: '0.95rem', fontWeight: '700', cursor: 'pointer',
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '0.8rem', marginBottom: '1.2rem'  }}>
                          {['UPI', 'Cash', 'Bank Transfer'].map(mode => (
                            <button
                              ...
                              style={{ background: paymentMode === mode ? "var(--bg-blue-soft)" : "var(--bg-tertiary)",
