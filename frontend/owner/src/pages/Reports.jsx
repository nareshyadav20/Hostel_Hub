          ...
          <div style={{ background: 'var(--bg-tertiary)', padding: '0.4rem', borderRadius: '12px', display: 'flex', gap: '0.4rem'  }}>
            {['week', 'month', 'quarter'].map(r => (
              <button 
                ...
                style={{ padding: '0.4rem 0.8rem', borderRadius: '8px', border: 'none', fontSize: '0.75rem', fontWeight: '700',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem'  }}>
          {[
            ...
            <button 
              ...
              style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', padding: '0.8rem 1rem', 
