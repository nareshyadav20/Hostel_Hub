      ...
      <div className="card" style={{ padding: '2rem', borderRadius: '24px', marginBottom: '2rem', display: 'flex', gap: '2.5rem', alignItems: 'center', flexWrap: 'wrap', position: 'relative'  }}>
        <div style={{ position: 'relative'  }}>
          ...
          <label
            ...
            style={{ position: 'absolute', bottom: '0', right: '0', width: '36px', height: '36px', borderRadius: '50%', background: 'var(--accent-primary)', color: "var(--text-on-primary)", border: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', boxShadow: '0 4px 12px rgba(99,102,241,0.4)'  }}
          >
            <Camera size={18} />
          </label>
          <input
      ...
      <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '2rem', background: 'var(--bg-secondary)', padding: '0.5rem', borderRadius: '16px', border: '1px solid var(--border-color)', overflowX: 'auto'  }}>
        {tabs.map(tab => (
          <button
            ...
            style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', padding: '0.7rem 1.2rem', borderRadius: '12px',
        ...
        {message && (
          <motion.div
            ...
            style={{ position: 'fixed', bottom: '2rem', right: '2rem', zIndex: 1000,
              ...
              color: "var(--text-on-primary)", fontWeight: '700', boxShadow: 'var(--shadow-lg)'
             }}
          >
            {message.text}
          </motion.div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '3rem'  }}>
        ...
        <section style={{ borderTop: '1px solid var(--border-color)', paddingTop: '3rem'  }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem'  }}>
            ...
            >
              <div style={{ position: 'absolute', top: '3px', left: profile.securitySettings.twoFactorEnabled ? '29px' : '3px', width: '24px', height: '24px', borderRadius: '50%', background: "var(--bg-card)", transition: 'all 0.3s cubic-bezier(0.68, -0.55, 0.265, 1.55)', boxShadow: '0 2px 4px rgba(0,0,0,0.2)'  }} />
            </div>
          </div>
        </section>
