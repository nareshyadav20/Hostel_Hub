        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem'  }}>
          ...
          <div className="input-group">
            ...
            {formData.gallery && formData.gallery.length > 0 ? (
              ...
              <img
                src={(formData.coverImage.startsWith('http') || formData.coverImage.startsWith('data:')) ? formData.coverImage : `https://livora-hostel-hub-1.onrender.com${formData.coverImage}`}
                alt="Cover"
