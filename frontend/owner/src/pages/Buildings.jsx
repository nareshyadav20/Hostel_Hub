    ...
    {isOpen && (
      <div style={{ position: 'fixed', inset: 0, zIndex: 3000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1rem'  }}>
        ...
        <motion.div
          ...
          style={{ position: 'relative', width: '100%', maxWidth: '950px', maxHeight: '90vh',
        ...
        >
          {/* Modal Header */}
          <div style={{ padding: '1.2rem 2.5rem', borderBottom: '1px solid #F1F5F9',
      ...
      {isOpen && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 4000, display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '1rem'  }}>
          ...
          <motion.div
            ...
            style={{ position: 'relative', width: '100%', maxWidth: '1100px', height: '95vh',
              background: "var(--bg-card)", borderRadius: '32px', overflow: 'hidden',
              ...
              <div style={{ display: 'flex', gap: '0.5rem', marginTop: '2.5rem', overflowX: 'auto', scrollbarWidth: 'none', paddingBottom: '0.5rem'  }}>
                {tabs.map(tab => (
                  <button
                    ...
                    style={{ padding: '0.8rem 1.4rem', borderRadius: '14px',
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.8rem', marginTop: '0.5rem'  }}>
              {['Bed', 'Cupboard', 'Study Table', 'Mirror', 'Fan', 'Curtains'].map(item => (
                <div 
                  ...
                  style={{ padding: '0.5rem 1rem', borderRadius: '10px', fontSize: '0.8rem', fontWeight: '800', cursor: 'pointer',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem', maxHeight: '400px', overflowY: 'auto', paddingRight: '0.5rem'  }}>
            {[
              ...
              <motion.div 
                ...
                style={{ padding: '1rem 1.5rem', borderRadius: '20px', border: '1px solid #E2E8F0', 
                  display: 'flex', justifyContent: 'space-between', alignItems: 'center', 
              ...
              >
                ...
                <div style={{ textAlign: 'right'  }}>
                  <span style={{ padding: '0.3rem 0.6rem', borderRadius: '8px', background: tenant.status === 'Verified' ? '#ECFDF5' : '#FEF2F2', 
...
const PremiumBuildingCard = ({ building, onSelect, onViewAnalytics, onEditBuilding, onDeleteBuilding }) => {
  ...
  const images = useMemo(() => {
    if (building.images && building.images.length > 0) {
      return building.images.map(img => (img.startsWith('http') || img.startsWith('data:')) ? img : `https://livora-hostel-hub.onrender.com${img}`);
    }
    return [
  ...
  return (
    ...
    >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start'  }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '0.6rem'  }}>
              <span style={{ padding: '0.4rem 0.8rem', borderRadius: '12px', background: '#0F172A', color: "var(--text-on-primary)", 
      ...
      {/* Hero Visualization */}
      <div style={{ position: 'relative', height: '220px', borderRadius: '32px', overflow: 'hidden', 
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: '1rem', zIndex: 1  }}>
        {/* Financial Bento */}
        <div style={{ padding: '1.5rem', borderRadius: '32px', 
      ...
      <div style={{ marginTop: 'auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.8rem', 
        ...
        <button 
          ...
          style={{ padding: '1.1rem', borderRadius: '22px', background: '#F8FAFC', color: '#0F172A', 
        ...
        <button 
          ...
          style={{ padding: '1.1rem', borderRadius: '22px', fontWeight: '950', fontSize: '0.85rem', flex: 1,
...
const PremiumFloorCard = ({ floor, building, onSelect, onViewAnalytics, onDelete }) => {
  ...
  return (
    ...
    >
      {/* Background Neon Accent */}
      <div style={{ position: 'absolute', top: '-100px', right: '-100px', width: '250px', height: '250px',
      ...
      <div style={{ position: 'relative', height: '240px', borderRadius: '32px', overflow: 'hidden', 
        background: '#F1F5F9', border: '1px solid rgba(255,255,255,0.8)', zIndex: 1 
       }}>
        <img 
      ...
      {/* Action Footer */}
      <div style={{ marginTop: 'auto', display: 'grid', gridTemplateColumns: '1.2fr 0.6fr 1.2fr', gap: '0.8rem', 
        paddingTop: '1.2rem', borderTop: '1px solid #F1F5F9', zIndex: 1 
       }}>
        <button 
          className="btn" 
          onClick={(e) => { e.stopPropagation(); onViewAnalytics(floor, 'floor'); }}
          style={{ padding: '0.6rem 1rem', borderRadius: '20px', background: '#F8FAFC', color: '#0F172A', 
            fontWeight: '950', fontSize: '0.85rem', border: '1px solid #E2E8F0', 
        ...
        <button 
          ...
          style={{ padding: '1rem', borderRadius: '18px', background: '#FEF2F2', color: '#EF4444', 
        ...
        <button 
          ...
          style={{ padding: '1rem', borderRadius: '20px', fontWeight: '950', fontSize: '0.85rem',
            boxShadow: '0 10px 20px rgba(99, 102, 241, 0.3)'
           }}
        >
          View Rooms
...
const PremiumRoomCard = ({ room, floor, onSelect, onViewDetails, onEdit, onDelete }) => {
  ...
  return (
    ...
    >
      ...
      {/* Hero Image Section */}
      <div style={{ position: 'relative', height: '220px', borderRadius: '28px', overflow: 'hidden', 
        background: '#F1F5F9', border: '1px solid rgba(255,255,255,0.8)', zIndex: 1 
       }}>
        <img 
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '1rem', zIndex: 1  }}>
        ...
        {/* AI Insight Bento */}
        <div style={{ padding: '1.5rem', borderRadius: '28px', 
          background: 'linear-gradient(135deg, #0F172A 0%, #1E293B 100%)', 
          color: "var(--text-on-primary)", display: 'flex', flexDirection: 'column', gap: '0.8rem' 
         }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem'  }}>
      ...
      <div style={{ marginTop: 'auto', display: 'grid', gridTemplateColumns: '1.2fr 0.6fr 1.2fr', gap: '0.8rem', 
        ...
        <button 
          ...
          style={{ padding: '0.6rem 1rem', borderRadius: '18px', background: '#F8FAFC', color: '#0F172A', 
            fontWeight: '950', fontSize: '0.85rem', border: '1px solid #E2E8F0', 
            display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.8rem' 
           }}
        >
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', zIndex: 1  }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem', alignItems: 'flex-end'  }}>
          ...
          <div style={{ display: 'flex', gap: '0.3rem'  }}>
            <button 
              onClick={() => onEdit(bed)}
              style={{ width: '32px', height: '32px', borderRadius: '10px', background: "var(--bg-card)",
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.8rem'  }}>
        {/* Specifications */}
        <div className="bento-item" style={{ background: 'rgba(248, 250, 252, 0.8)',
          padding: '1rem',
          borderRadius: '20px',
          display: 'flex',
          flexDirection: 'column',
        ...
        <div className="bento-item" style={{ gridColumn: 'span 2',
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.6rem'  }}>
            {features.comfort.map(f => (
              <div key={f.id} style={{ padding: '0.4rem 0.6rem',
                borderRadius: '10px',
                background: "var(--bg-card)",
    ...
    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '2.5rem', alignItems: 'center'  }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '1.2rem'  }}>
        <motion.button 
          whileHover={{ x: -5 }}
          onClick={onBack} 
          style={{ width: '45px', height: '45px', borderRadius: '15px', 
