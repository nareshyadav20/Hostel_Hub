                    ...
                    <div style={{ display:'flex', gap:'0.5rem', justifyContent:'flex-end' }}>
                      {p.status === 'Paid' || p.status === 'Success' || p.status === 'Refunded' ? (
                        ...
                        <button onClick={() => { 
                          ...
                          style={{ padding:'0.45rem 0.8rem', border:'none', background:'#10B981', color:'white', display:'flex', alignItems:'center', gap:'0.35rem', fontSize:'0.75rem', fontWeight:'700', borderRadius:'8px', cursor:'pointer' }}>
        ...
        {detailsItem && (
          <>
            ...
            <motion.div initial={{ y:40, opacity:0 }} animate={{ y:0, opacity:1 }} exit={{ y:40, opacity:0 }} style={modalBase}>
              ...
              {/* Status Banner */}
              <div style={{ padding:'1.5rem', borderRadius:'16px', marginBottom:'1.5rem',
