                      ...
                      .map((b) => (
                        <React.Fragment key={b.id}>
                          <tr
                            ...
                            className={`group hover:bg-background transition-all cursor-pointer ${expandedId === b.id ? 'bg-primary/5' : ''}`}
                          >
                            ...
                            <td className="py-4 px-4">
                              <span className={`px-2.5 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest border shadow-sm ${b.status === 'Confirmed' ? 'bg-emerald-500/10 text-emerald-500 border-emerald-500/20 shadow-emerald-500/5' :
              ...
              {mappedBookings
                ...
                .map((b) => (
                  <motion.div
                    key={b.id}
                    layout
                    className={`card-classic group flex flex-col transition-all duration-500 overflow-hidden ${expandedId === b.id ? 'col-span-full ring-2 ring-primary ring-offset-4 dark:ring-offset-slate-900 shadow-2xl' : ''
                      }`}
                  >
                    <div className="p-8">
