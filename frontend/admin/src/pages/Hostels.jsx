          ...
          >
            ...
            <div className="relative h-56 overflow-hidden">
               ...
               <div className="absolute top-4 right-4 flex gap-2">
                  <span className={`px-3 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest backdrop-blur-md border border-white/20 shadow-xl ${
                    h.status === 'Active' ? 'bg-success/80 text-white' : h.status === 'Full' ? 'bg-indigo-500/80 text-white' : 'bg-warning/80 text-white'
                  }`}>
                    {h.status}
                  </span>
               </div>
