        ...
        {activeTab === 'laundry' && (
          <div className="fade-in">
            <h3 style={{ fontSize: '1.4rem', fontWeight: '800', marginBottom: '0.5rem', display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--accent-primary)" strokeWidth="2.5"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
              Laundry Tracking
            </h3>
            <p style={{ color: 'var(--text-muted)', marginBottom: '1.5rem' }}>Track your laundry status in real-time.</p>
            
            <div className="glass-card" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '2rem', borderRadius: '16px' }}>
              <div style={{ textAlign: 'center', color: 'var(--accent-primary)', fontWeight: '800' }}>
                <div style={{ background: 'rgba(14, 165, 233, 0.1)', width: '60px', height: '60px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 0.8rem' }}>
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="20 6 9 17 4 12"></polyline></svg>
                </div>
                Requested
              </div>
              <div style={{ flex: 1, height: '4px', background: 'linear-gradient(90deg, var(--accent-primary) 50%, var(--bg-tertiary) 50%)', margin: '0 1rem', borderRadius: '2px' }}></div>
              <div style={{ textAlign: 'center', color: 'var(--text-muted)', fontWeight: '700' }}>
                <div style={{ background: 'var(--bg-tertiary)', width: '60px', height: '60px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 0.8rem' }}>
              ...
              <div style={{ flex: 1, height: '4px', background: 'var(--bg-tertiary)', margin: '0 1rem', borderRadius: '2px' }}></div>
              <div style={{ textAlign: 'center', color: 'var(--text-muted)', fontWeight: '700' }}>
                <div style={{ background: 'var(--bg-tertiary)', width: '60px', height: '60px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 0.8rem' }}>
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"></circle><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"></path><path d="M2 12h20"></path></svg>
                </div>
                Washing
              </div>
              <div style={{ flex: 1, height: '4px', background: 'var(--bg-tertiary)', margin: '0 1rem', borderRadius: '2px' }}></div>
              <div style={{ textAlign: 'center', color: 'var(--text-muted)', fontWeight: '700' }}>
                <div style={{ background: 'var(--bg-tertiary)', width: '60px', height: '60px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 0.8rem' }}>
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="1" y="3" width="15" height="13"></rect><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"></polygon><circle cx="5.5" cy="18.5" r="2.5"></circle><circle cx="18.5" cy="18.5" r="2.5"></circle></svg>
                </div>
                Delivered
              </div>
            </div>
