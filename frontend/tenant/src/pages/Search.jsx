          ...
          {loading ? (
            ...
            <>
              <div className="results-meta-bar">
                <span className="results-meta-count"><strong>{hostels.length}</strong> stays found</span>
                {activeFilterCount > 0 && (
                  <button className="results-clear-btn" onClick={clearAllFilters}>
